...
public class ButterflyProperties {
    ...
    private int butterflyServerBusinessThreadNums = Runtime.getRuntime ().availableProcessors () * 3;
    private int pingPineServiceDelay = 20000;
    private int updateProducerClusterCacheDelay = 10000;
